...
function GithubContainer() {
            ...
            return reposInfo.sort((a, b) => (Date.parse(b["pushed_at"]) - Date.parse(a["pushed_at"]))).map((value, index) => 
                (
                    <div className="gitRepoContainer" key={index}>
                        ...
                        <div className="gitInfoContainer">
                            <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="100" data-view-component="true">
    ...
    return (
        <div className="git">
            ...
            <div className="gitLogosContainer">
